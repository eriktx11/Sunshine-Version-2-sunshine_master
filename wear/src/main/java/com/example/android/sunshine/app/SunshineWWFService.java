...
/**
 * Created by erikllerena on 7/26/16.
 */
public class SunshineWWFService extends WeatherWatchFaceService{
    ...
    private class Engine extends WeatherWatchFaceEngine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mTemperaturePaintLow = createTextPaint(mResources.getColor(R.color.runner_temperature_color), tempFont);
            mTemperatureSuffixPaintLow = createTextPaint(mResources.getColor(R.color.runner_temperature_color), tempFont);
        }
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            float tempTextSizeLow = mResources.getDimension(isRound ?
                    R.dimen.runner_temperature_size_round_min : R.dimen.runner_temperature_size_min);

            float tempSuffixTextSizeLow = mResources.getDimension(isRound ?
                    R.dimen.runner_temperature_suffix_size_round_min : R.dimen.runner_temperature_suffix_size_min);
            ...
            mTemperaturePaintLow.setTextSize(tempTextSizeLow);
            mTemperatureSuffixPaintLow.setTextSize(tempSuffixTextSizeLow);
...
//            mSunsetTime.set(mWeatherInfoReceivedTime+10000);
            ...
            canvas.drawText(hourString, x, y-60, mTimePaint);

            x = radius - mColonXOffset + mTimeXOffset;
            canvas.drawText(Consts.COLON_STRING, x, y-60, mTimePaint);

            x = radius + mColonXOffset + mTimeXOffset;
            canvas.drawText(minString, x, y-60, mTimePaint);
            ...
            canvas.drawText(monthString, x, y-60, mDatePaint);
            x += monthWidth;
            canvas.drawText(dayString, x, y-60, mDatePaint);
            x += dayWidth;
            canvas.drawText(daySuffixString, x, suffixY-60, mDateSuffixPaint);
...
//                    }
                    ...
                    if (mWeatherCondition.equals("clear")) {

                        stringBuilder.append("clear");
                    }

                    if (mWeatherCondition.equals("clouds")) {

                        stringBuilder.append("clouds");
                    }

                    if (mWeatherCondition.equals("fog")) {

                        stringBuilder.append("fog");
                    }

                    if (mWeatherCondition.equals("rain")) {

                        stringBuilder.append("rain");
                    }

                    if (mWeatherCondition.equals("storm")) {

                        stringBuilder.append("storm");
                    }

                    if (mWeatherCondition.equals("snow")) {
                    ...
                    if (!name.equals(mWeatherConditionResourceName)) {
                        ...
                        mWeatherConditionDrawable = Bitmap.createScaledBitmap(mWeatherConditionDrawable, (int) (mWeatherConditionDrawable.getWidth() * sizeScale-35), (int) (mWeatherConditionDrawable.getHeight() * sizeScale-35), true);
                ...
                if (mTemperature != Integer.MAX_VALUE && !(isRound && hasPeekCard)) {
                    ...
                    String temperatureScaleString = "C";
                            //mTemperatureScale == ConverterUtil.FAHRENHEIT ? ConverterUtil.FAHRENHEIT_STRING : ConverterUtil.CELSIUS_STRING;
                    ...
                    canvas.drawText(temperatureString, x+50, y-40, mTemperaturePaint);
                    x += temperatureWidth;
                    canvas.drawText(temperatureScaleString, x+50, suffixY-40, mTemperatureSuffixPaint);
                }


                if (mTemperatureLow != Integer.MAX_VALUE && !(isRound && hasPeekCard)) {
                    String temperatureString = String.valueOf(mTemperatureLow);
                    String temperatureScaleString = "C";
                    //mTemperatureScale == ConverterUtil.FAHRENHEIT ? ConverterUtil.FAHRENHEIT_STRING : ConverterUtil.CELSIUS_STRING;
                    float temperatureWidth = mTemperaturePaintLow.measureText(temperatureString);
                    float temperatureRadius = (temperatureWidth + mTemperatureSuffixPaintLow.measureText(temperatureScaleString)) / 2;
                    float borderPadding = temperatureRadius * 0.5f;
                    x = radius;
                    if (hasPeekCard) {
                        y = getPeekCardPosition().top - temperatureRadius - borderPadding - mTemperatureBorderPaint.getStrokeWidth() * 2;
                    ...
                    x -= temperatureRadius;
                    y -= mTemperatureYOffset;
                    canvas.drawText(temperatureString, x+51, y-7, mTemperaturePaintLow);
                    x += temperatureWidth;
                    canvas.drawText(temperatureScaleString, x+51, suffixY-7, mTemperatureSuffixPaintLow);
                }
